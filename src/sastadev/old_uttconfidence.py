...
if __name__ == '__main__':
    fulltable = []
    selected_trainingdatasets = [ds for ds in trainingdatasets if ds.method == tarsp and ds.variant == tarspauris ]  # for testing
    for dataset in selected_trainingdatasets:
        method = getmethod(dataset.method, variant=dataset.variant)
        mytry1(method.name, dataset.variant)
