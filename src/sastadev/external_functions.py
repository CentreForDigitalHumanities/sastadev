...
from sastadev.queryfunctions import (VzN, hequery, into, tarsp_mvzn, tarsp_verkl,
...
# Initialisation
thetarspfunctions = [bbx, getcompounds, hequery, into, sziplus6, xenx, vr5plus, wx, wxy, wxyz, wxyz5, wondx, wond4, wond5plus,
